...
public class TestDataInitializer implements ApplicationInitializer {
  ...
  public void initialize() {
    dataProperties.purchaseRequests.forEach(productionExecutionService::create);
  }
  ...
  public static class DataProperties {
    ...
    List<ProductionExecutionRequests.CreateRequest> purchaseRequests = new LinkedList<>();
